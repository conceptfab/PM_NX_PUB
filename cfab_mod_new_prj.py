...
def create_new_project(settings_list):
    ...
    prj_list_client = input('Podaj nazwę klienta: ')  # TODO dodać do stringów
    ...
    prj_full_name = prj_list_nr + '_' + prj_list_year + \
        '_' + prj_list_client + '_' + prj_list_name
    prj_list = (
        settings_list[0], prj_list_nr, prj_list_year, prj_list_code, prj_list_client, prj_list_name,
        prj_full_name, prj_list_desc, prj_list_budget, prj_list_term)
    ...
    send_email(project_dict, settings_list[7],
...
def copy_default_files(settings_list, prj_list):
    ...
    path = settings_list[0] + '/' + \
        settings_list[3] + '/default_files/default.pln'
    prj_name = prj_list[6]
    new_path = settings_list[0] + '/' + prj_name + '/02_' + prj_list[3] + \
        '_AC_files/' + prj_name + '.pln'
    try:
